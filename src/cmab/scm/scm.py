...
class SCM:
    ...
    def support(self, variable:str) -> set[int]:
        """TODO: only works for discrete variables now, expensive computation adn might not capture all support if the variables can take
        other values than those generated by the exogenous variables. 
        """
        support = set()
