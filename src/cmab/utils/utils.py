...
def compute_means_history(environment, T, effective_action_space=None):
    """
    Compute the means history for each arm in the environment over T time steps, taking into account the change points

    Parameters:
    - environment: The environment object which contains the SCM.
